import {
  ...
  GenericAvatarIcon,
  useAvatarStyles
} from "./chunk-QDMOMWYH.js";
import {
  Image,
  Img,
  useImage
} from "./chunk-H6UF2WMS.js";
import {
  AbsoluteCenter,
  AspectRatio,
  Badge,
...
import {
  ...
  usePortalManager,
  useToast
} from "./chunk-VAMM5YUS.js";
import {
  Icon,
  createIcon
} from "./chunk-OFZMP4KR.js";
import {
  Spinner
} from "./chunk-LTMUB5VE.js";
import {
  Menu,
  MenuButton,
  MenuCommand,
  ...
  useMenuStyles,
  usePopper
} from "./chunk-LQUE32WX.js";
import {
  getValidChildren
} from "./chunk-QSMKY4HM.js";
import {
  mergeRefs
} from "./chunk-RRGD2LFP.js";
import {
  useCallbackRef,
  useUpdateEffect
} from "./chunk-OJOBW4FT.js";
import {
  AnimatePresence,
  motion,
  usePresence
} from "./chunk-E67GCWGG.js";
import {
  createContext
} from "./chunk-VHEUQ5HP.js";
import {
  CSSVars,
  ColorModeContext,
  ColorModeProvider,
...
} from "./chunk-GQ7YOENZ.js";
import "./chunk-DGP5C23S.js";
import {
  require_jsx_runtime
...
var focusScope = (0, import_react24.createContext)(void 0);
...
var FocusLock2 = (props) => {
  ...
  const onActivation = (0, import_react28.useCallback)(() => {
  ...
  const onDeactivation = (0, import_react28.useCallback)(() => {
    var _a2;
...
function useShortcut(props = {}) {
  ...
  const [keys, setKeys] = (0, import_react30.useState)([]);
  ...
  (0, import_react30.useEffect)(() => flush, []);
...
var useSafeLayoutEffect2 = isBrowser ? import_react31.useLayoutEffect : import_react31.useEffect;

// node_modules/@chakra-ui/hooks/dist/chunk-KA2477BY.mjs
var import_react32 = __toESM(require_react(), 1);
function useCallbackRef3(fn, deps = []) {
  const ref = (0, import_react32.useRef)(fn);
  useSafeLayoutEffect2(() => {
    ref.current = fn;
  });
  return (0, import_react32.useCallback)((...args) => {
    var _a2;
...
function useWhyDidYouUpdate(name, props) {
  const previousProps = (0, import_react34.useRef)();
...
function useMouseDownRef(shouldListen = true) {
  const mouseDownRef = (0, import_react39.useRef)();
...
function useOutsideClick(props) {
  ...
  const stateRef = (0, import_react40.useRef)({
    isPointerDown: false,
...
function usePanGesture(ref, props) {
  ...
  const panSession = (0, import_react42.useRef)(null);
  const handlers2 = {
...
function useOptionalPart(partId) {
  const [id, setId] = (0, import_react43.useState)(null);
...
function useControllableState2(props) {
  ...
  const [valueState, setValue] = (0, import_react44.useState)(defaultValue);
  const isControlled = valueProp !== void 0;
  const value = isControlled ? valueProp : valueState;
  const updateValue = (0, import_react44.useCallback)(
    (next) => {
...
function useDisclosure2(props = {}) {
  ...
  const [isOpenState, setIsOpen] = (0, import_react45.useState)(props.defaultIsOpen || false);
  const [isControlled, isOpen] = useControllableProp(isOpenProp, isOpenState);
  const id = useId3(idProp, "disclosure");
  const onClose = (0, import_react45.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(false);
    }
    onClosePropCallbackRef == null ? void 0 : onClosePropCallbackRef();
  }, [isControlled, onClosePropCallbackRef]);
  const onOpen = (0, import_react45.useCallback)(() => {
    if (!isControlled) {
      setIsOpen(true);
    }
...
function useEventListenerMap() {
  const listeners = (0, import_react46.useRef)(/* @__PURE__ */ new Map());
  const currentListeners = listeners.current;
  const add = (0, import_react46.useCallback)((el, type, listener, options) => {
...
var useUpdateEffect2 = (effect2, deps) => {
  const renderCycleRef = (0, import_react47.useRef)(false);
  const effectCycleRef = (0, import_react47.useRef)(false);
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  const autoFocusRef = (0, import_react48.useRef)(autoFocusValue);
  const lastVisibleRef = (0, import_react48.useRef)(visible);
  useSafeLayoutEffect2(() => {
  ...
  const onFocus3 = (0, import_react48.useCallback)(() => {
...
function useForceUpdate() {
  const unloadingRef = (0, import_react49.useRef)(false);
  const [count, setCount] = (0, import_react49.useState)(0);
  useUnmountEffect(() => {
...
function useBoolean(initialState = false) {
  const [value, setValue] = (0, import_react51.useState)(initialState);
  const callbacks = (0, import_react51.useMemo)(
    () => ({
      on: () => setValue(true),
      off: () => setValue(false),
...
function useClipboard(value, optionsOrTimeout = {}) {
  const [hasCopied, setHasCopied] = (0, import_react52.useState)(false);
  const [valueState, setValueState] = (0, import_react52.useState)(value);
  (0, import_react52.useEffect)(() => setValueState(value), [value]);
  const { timeout = 1500, ...copyOptions } = typeof optionsOrTimeout === "number" ? { timeout: optionsOrTimeout } : optionsOrTimeout;
  const onCopy = (0, import_react52.useCallback)(() => {
...
function useDimensions(ref, observe) {
  const [dimensions, setDimensions] = (0, import_react54.useState)(null);
  const rafId = (0, import_react54.useRef)();
  useSafeLayoutEffect2(() => {
    function measure() {
      const node2 = ref.current;
      if (!node2)
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react55.cloneElement)(child, theming) : (0, import_react55.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
function useMediaQuery(query, options = {}) {
  ...
  const [value, setValue] = (0, import_react56.useState)(() => {
...
var ModalTransition = (0, import_react57.forwardRef)(
  (props, ref) => {
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react58.useState)(0);
...
function useModal(props) {
  ...
  const dialogRef = (0, import_react59.useRef)(null);
  ...
  const mouseDownTarget = (0, import_react59.useRef)(null);
  const onMouseDown = (0, import_react59.useCallback)((event) => {
  ...
  const [headerMounted, setHeaderMounted] = (0, import_react59.useState)(false);
  const [bodyMounted, setBodyMounted] = (0, import_react59.useState)(false);
  const getDialogProps = (0, import_react59.useCallback)(
    (props2 = {}, ref = null) => ({
      role: "dialog",
      ...props2,
  ...
  const onOverlayClick = (0, import_react59.useCallback)(
    (event) => {
      event.stopPropagation();
  ...
  const getDialogContainerProps = (0, import_react59.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
...
function useSpinner(increment, decrement) {
  const [isSpinning, setIsSpinning] = (0, import_react65.useState)(false);
  const [action, setAction] = (0, import_react65.useState)(null);
  const [runOnce, setRunOnce] = (0, import_react65.useState)(true);
  ...
  const up = (0, import_react65.useCallback)(() => {
    if (runOnce) {
      increment();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const down = (0, import_react65.useCallback)(() => {
    if (runOnce) {
      decrement();
    }
    timeoutRef.current = setTimeout(() => {
  ...
  const stop = (0, import_react65.useCallback)(() => {
    setRunOnce(true);
    setIsSpinning(false);
    removeTimeout();
  }, []);
...
function useNumberInput(props = {}) {
  ...
  const [isFocused, setFocused] = (0, import_react66.useState)(false);
  const isInteractive = !(isReadOnly || isDisabled);
  const inputRef = (0, import_react66.useRef)(null);
  const inputSelectionRef = (0, import_react66.useRef)(null);
  const incrementButtonRef = (0, import_react66.useRef)(null);
  const decrementButtonRef = (0, import_react66.useRef)(null);
  const sanitize = (0, import_react66.useCallback)(
    (value) => value.split("").filter(isValidCharacter).join(""),
    [isValidCharacter]
  );
  const parse3 = (0, import_react66.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react66.useCallback)(
    (value) => {
      var _a2;
  ...
  const increment = (0, import_react66.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        incrementFn(step);
      }
  ...
  const decrement = (0, import_react66.useCallback)(
    (step = stepProp) => {
      if (isInteractive) {
        decrementFn(step);
      }
  ...
  const _onFocus = (0, import_react66.useCallback)(
    (event) => {
      var _a2, _b, _c;
  ...
  const ariaValueText = (0, import_react66.useMemo)(() => {
  ...
  const validateAndClamp = (0, import_react66.useCallback)(() => {
  ...
  const onInputBlur = (0, import_react66.useCallback)(() => {
    setFocused(false);
    if (clampValueOnBlur) {
      validateAndClamp();
    }
  }, [clampValueOnBlur, setFocused, validateAndClamp]);
  const focusInput = (0, import_react66.useCallback)(() => {
  ...
  const spinUp = (0, import_react66.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.up();
      focusInput();
  ...
  const spinDown = (0, import_react66.useCallback)(
    (event) => {
      event.preventDefault();
      spinner.down();
      focusInput();
  ...
  const getIncrementButtonProps = (0, import_react66.useCallback)(
    (props2 = {}, ref = null) => {
  ...
  const getDecrementButtonProps = (0, import_react66.useCallback)(
    (props2 = {}, ref = null) => {
...
function usePinInput(props = {}) {
  ...
  const uuid = (0, import_react68.useId)();
  const id = idProp != null ? idProp : `pin-input-${uuid}`;
  const descendants = usePinInputDescendants();
  const [moveFocus2, setMoveFocus] = (0, import_react68.useState)(true);
  ...
  const focusNext = (0, import_react68.useCallback)(
    (index) => {
  ...
  const setValue = (0, import_react68.useCallback)(
  ...
  const clear = (0, import_react68.useCallback)(() => {
    var _a2;
  ...
  const getNextValue = (0, import_react68.useCallback)((value2, eventValue) => {
...
function PinInput(props) {
  ...
  const clones = getValidChildren(children).map(
    (child) => (0, import_react69.cloneElement)(child, { __css: styles })
  );
...
function PopoverTrigger(props) {
  ...
  return (0, import_react70.cloneElement)(child, getTriggerProps(child.props, child.ref));
}
...
function usePopover(props = {}) {
  ...
  const anchorRef = (0, import_react71.useRef)(null);
  const triggerRef = (0, import_react71.useRef)(null);
  const popoverRef = (0, import_react71.useRef)(null);
  const isHoveringRef = (0, import_react71.useRef)(false);
  const hasBeenOpened = (0, import_react71.useRef)(false);
  if (isOpen) {
    hasBeenOpened.current = true;
  }
  const [hasHeader, setHasHeader] = (0, import_react71.useState)(false);
  const [hasBody, setHasBody] = (0, import_react71.useState)(false);
  ...
  const getPopoverProps = (0, import_react71.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const popoverProps = {
        ...props2,
        style: {
  ...
  const getPopoverPositionerProps = (0, import_react71.useCallback)(
  ...
  const getAnchorProps = (0, import_react71.useCallback)(
    (props2, _ref2 = null) => {
      return {
        ...props2,
  ...
  const openTimeout = (0, import_react71.useRef)();
  const closeTimeout = (0, import_react71.useRef)();
  const maybeReferenceRef = (0, import_react71.useCallback)(
    (node2) => {
  ...
  const getTriggerProps = (0, import_react71.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getHeaderProps = (0, import_react71.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: headerId,
  ...
  const getBodyProps = (0, import_react71.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      id: bodyId,
      ref: mergeRefs(ref, (node2) => {
...
function PopoverAnchor(props) {
  const child = import_react72.Children.only(props.children);
  const { getAnchorProps } = usePopoverContext();
  return (0, import_react72.cloneElement)(child, getAnchorProps(child.props, child.ref));
}
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react73.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react73.useRef)(null);
  const focus2 = (0, import_react73.useCallback)(() => {
  ...
  const uuid = (0, import_react73.useId)();
  ...
  const getRootProps = (0, import_react73.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react74.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const uuid = `radio-${(0, import_react75.useId)()}`;
  ...
  const [isHovered, setHovering] = (0, import_react75.useState)(false);
  const [isActive, setActive] = (0, import_react75.useState)(false);
  const [isCheckedState, setChecked] = (0, import_react75.useState)(Boolean(defaultChecked));
  ...
  const getRadioProps = (0, import_react75.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react76.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime72.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react76.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react77.useRef)(true);
...
var useSafeLayoutEffect3 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react81.useLayoutEffect : import_react81.useEffect;
...
function useSizes({
  ...
  const [count, setCount] = (0, import_react81.useState)(0);
...
function useRangeSlider(props) {
  ...
  const [activeIndex, setActiveIndex] = (0, import_react82.useState)(-1);
  const isInteractive = !(isDisabled || isReadOnly);
  const initialValue = (0, import_react82.useRef)(valueState);
  ...
  const getOutputProps = (0, import_react82.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react83.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react84.useState)(false);
  ...
  const trackRef = (0, import_react84.useRef)(null);
  const thumbRef = (0, import_react84.useRef)(null);
  const rootRef = (0, import_react84.useRef)(null);
  const reactId = (0, import_react84.useId)();
  const uuid = idProp != null ? idProp : reactId;
  const [thumbId, trackId] = [`slider-thumb-${uuid}`, `slider-track-${uuid}`];
  const getValueFromPointer = (0, import_react84.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react84.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const actions = (0, import_react84.useMemo)(
    () => ({
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react84.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react84.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getTrackProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react84.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getMarkerProps = (0, import_react84.useCallback)(
    (props2, ref = null) => {
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react85.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react86.useState)(index);
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react88.useState)(defaultIndex != null ? defaultIndex : 0);
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react88.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react88.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react88.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react88.useState)(false);
  useSafeLayoutEffect(() => {
...
function useTooltip(props = {}) {
  ...
  const enterTimeout = (0, import_react90.useRef)();
  const clearEnterTimeout = (0, import_react90.useCallback)(() => {
    if (enterTimeout.current) {
      clearTimeout(enterTimeout.current);
      enterTimeout.current = void 0;
    }
  }, []);
  const exitTimeout = (0, import_react90.useRef)();
  const clearExitTimeout = (0, import_react90.useCallback)(() => {
    if (exitTimeout.current) {
      clearTimeout(exitTimeout.current);
      exitTimeout.current = void 0;
    }
  }, []);
  const closeNow = (0, import_react90.useCallback)(() => {
    clearExitTimeout();
    onClose();
  }, [onClose, clearExitTimeout]);
  const dispatchCloseEvent = useCloseEvent(ref, closeNow);
  const openWithDelay = (0, import_react90.useCallback)(() => {
  ...
  const closeWithDelay = (0, import_react90.useCallback)(() => {
    clearEnterTimeout();
    const win = getWin(ref);
  ...
  const onPointerDown = (0, import_react90.useCallback)(() => {
  ...
  const getTriggerProps = (0, import_react90.useCallback)(
    (props2 = {}, _ref2 = null) => {
      const triggerProps = {
        ...props2,
  ...
  const getTooltipPositionerProps = (0, import_react90.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react90.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    trigger2 = (0, import_react91.cloneElement)(
      child,
